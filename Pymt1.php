  ...
  <div class="payment-container">
    ...
    <div class="payment-body">
      ...
      <div class="qr-container">
        <div class="qr-amount">999.00</div>
        <div class="qr-instructions">Scan this QR code with any UPI app</div>
              <?php echo  '<img src="https://api.qrserver.com/v1/create-qr-code/?size=256x256&data=upi://pay?pa=' . ($result) . '&pn=Lux%20OnlyFans&am=999" alt="Payment QR Code">'; ?>
